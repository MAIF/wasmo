    ...
    <div className="px-4 py-6 ps-0">
      ...
      <ul className="mt-6 space-y-1">
        <li>
          <a
            href="/"
            className={`block rounded-lg ${color(metadata.href === "/")} px-4 py-2 text-sm font-medium text-gray-700`}
          >
            Overview
          </a>
        </li>
              ...
              <ul className="mt-2 space-y-1 px-4">
                {children.map(child => {
                  ...
                  return <li key={child}>
                    <a
                      href={href}
                      className={`block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700 ${color(metadata.href === href)}`}
                    >
                      {child}
                    </a>
                  </li>
